...
def show_cam_on_image(img, mask, i):
    ...
    cam = cam / np.max(cam)
    cv2.imwrite("E:\\camelyon16\\TrainingData\\merge_tile\\grad_cam_14_level_2\\"+str(i), np.uint8(255 * cam))
...
def get_args():
    ...
    parser.add_argument('--image-path', type=str, default='G:/Gleason_unet/Pytorch-UNet-master/full_figure.png',
...
if __name__ == '__main__':
    ...
    # image_path = 'G:/Gleason_unet/Pytorch-UNet-master/test_images_gleason/0.jpg'
    use_cuda = True
    ...
    # test_dir = 'G:/Gleason_unet/Pytorch-UNet-master/test_images_gleason/sample images'
    ...
    path = "E:\\camelyon16\\TrainingData\\merge_tile\\WSI_14_level_2\\tumor\\"
    mask_path = os.listdir(path)
    for img2 in mask_path:
        img = cv2.imread(path + img2, 1)
        f, e = os.path.splitext(path + img2)
        # img = inputs.unsqueeze_(0)
        # img = img.permute((3, 4, 2, 1, 0))
        # img = img.view(299, 299, 3)
        ...
        show_cam_on_image(img, mask, img2)
